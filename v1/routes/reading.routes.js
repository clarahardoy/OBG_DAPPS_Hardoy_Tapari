...
READING_ROUTES.post('/', validateBody(addReadingSchema), ReadingController.createReading);
...
READING_ROUTES.patch('/:id', validateObjectIdMiddleware, validateBody(updateReadingSchema), ReadingController.updateReadingById);
