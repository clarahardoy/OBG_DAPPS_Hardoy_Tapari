...
READING_ROUTES.post('/',
    validateBodyMiddleware(addReadingSchema),
    ReadingController.createReading);
READING_ROUTES.get('/',
    ReadingController.getAllReadings);
READING_ROUTES.get('/:id',
    validateObjectIdMiddleware,
    ReadingController.getReadingById);
READING_ROUTES.patch('/:id',
    validateObjectIdMiddleware,
    validateBodyMiddleware(updateReadingSchema),
    ReadingController.updateReadingById
);
READING_ROUTES.delete('/:id',
    validateObjectIdMiddleware,
    ReadingController.deleteReadingById);
