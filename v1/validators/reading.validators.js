...
export const addReadingSchema = Joi.object({
	...
	status: Joi.string()
		...
		.messages({
			...
			'any.only':
				'El estado debe ser FINISHED, ABANDONED, CURRENTLY_READING o WANT_TO_READ.',
			'any.required': 'El Estado es obligatorio.',
		}),
	startedReading: Joi.date().allow(null).optional().messages({
		'date.base': 'Debe ser una fecha válida.',
	}),
	finishedReading: Joi.date().allow(null).optional().messages({
		'date.base': 'Debe ser una fecha válida.',
	}),
